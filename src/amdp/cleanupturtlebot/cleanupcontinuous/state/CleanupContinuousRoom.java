...
@DeepCopyState
public class CleanupContinuousRoom implements ObjectInstance {
    public String name;
    public int top;
    public int left;
    public int bottom;
    ...
    public CleanupContinuousRoom(String name, int top, int left, int bottom, int right, String colour) {
        this.name = name;
        this.top = top;
        this.left = left;
        this.bottom = bottom;
    ...
    @Override
    public CleanupContinuousRoom copyWithName(String objectName) {
        return new CleanupContinuousRoom(objectName, top, left, bottom, right, colour);
    }
    ...
    @Override
    public CleanupContinuousRoom copy() {
        return new CleanupContinuousRoom(name, top, left, bottom, right, colour);
    }
